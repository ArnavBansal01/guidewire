...
export const mockClaimHistory: ClaimRecord[] = [
  {
    ...
    verification: 'Device geo-location matched disruption zone (Connaught Place, Delhi)',
    platformActivity: 'Verified active on Swiggy for 4 hours during disruption window',
  ...
  },
  {
    ...
    platformActivity: 'Active orders confirmed during high-AQI window (12-6 PM)',
  ...
  },
  {
    ...
    platformActivity: 'Reduced delivery capacity logged (15 deliveries vs avg 25)',
