...
const Admin = () => {
  ...
  const previewImpact = () => {
    ...
    const workerCount =
      { Delhi: 1, Mumbai: 1, Bangalore: 2, Chennai: 0, Hyderabad: 0, Pune: 0 }[
        simCity
      ] || 0;
    const payout =
      { Low: 250, Medium: 600, High: 900, Critical: 1500 }[simSeverity] || 500;
    ...
    <div className={`admin-dashboard ${theme}`}>
      <nav className="topnav">
        <div className="nav-brand">
          ...
          <span className="nav-name">GigAssure</span>
        </div>
        ...
        <main className="main">
            ...
            <>
              ...
              <div className="kpi-grid">
                ...
                <Kpi
                  ...
                  icon="⚠️"
                  label="Fraud Alerts"
                  value={loading ? "..." : String(stats.fraudAlerts)}
                ...
                <div>
                  ...
                  <Section title="System Terminal" tone="green">
                    <div className="terminal">
                      ...
                      {commandCenterTerminalExtras.map((item) => (
                        <div key={item.message} className={item.tone}>
                          {item.message}
                        </div>
                      ))}
                    </div>
                ...
                <Section title="Pending Approvals" tone="yellow">
                  ...
                  <div className="action-row">
                    <button
                      ...
                      type="button"
                      onClick={() => setActivePage("claims-mgmt")}
                    >
                      Review All
                    </button>
                  </div>
                </Section>
                <Section title="City Risk Summary" tone="red">
          ...
          {activePage === "workers" && (
            <>
              ...
              />
              <div className="kpi-grid">
                <Kpi tone="teal" icon="👥" label="Total Workers" value="4" />
                ...
                <div>
                  ...
                  <Section title="System Configuration" tone="orange">
                    <Field label="Fraud Score Threshold">
                      <input className="form-input" value="75%" readOnly />
                    </Field>
                    <Field label="Auto-Approve Confidence Minimum">
                      <input className="form-input" value="90%" readOnly />
                    </Field>
                    <div className="action-row">
                      <button className="btn btn-primary" type="button">
                        Apply Config
    ...
    <>
      <div className="health-ring">
        ...
        <div className="health-text">
          <div className="health-pct">97%</div>
          <div className="health-lbl">Health</div>
        </div>
      </div>
      <MiniStat label="Uptime" value="99.9%" tone="green" />
      <MiniStat label="Automation Rate" value="84%" tone="teal" />
      <MiniStat label="Pending Actions" value="3" tone="yellow" />
    </>
  );
}
