...
**GigShield** is an AI-powered parametric insurance platform that automatically compensates delivery workers for **lost income** when external disruptions impact their ability to work. *(Note: We strictly exclude coverage for health, accidents, or vehicle damage to focus purely on income protection).*
...
* **Basic Plan:** ₹35/week → Maximum payout: ₹350 *(Capped at ₹150/day)*
* **Standard Plan:** ₹50/week → Maximum payout: ₹600 *(Capped at ₹250/day)*
* **Premium Plan:** ₹80/week → Maximum payout: ₹1000 *(Capped at ₹400/day)*
...
* **Heavy Rain:** > 50 mm in 24 hours *(Weather API)*
* **Extreme Heat:** > 45°C *(Weather API)*
* **Severe Pollution:** AQI > 400 *(Air Quality API)*
* **Curfew:** Zone lockdown notification *(Traffic/Gov API)*
...
GigShield will initially launch as a **Progressive Web Application (PWA)** built on React/Next.js. 
